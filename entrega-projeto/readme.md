...
1. Entre no repositório da Reprograma e "forke" o [repositório da aula](https://github.com/reprograma/On13-TodasEmTech-DesafioES6)
...
5. Dentro da pasta entrega-projeto, faça uma cópia da pasta github-search e renomei com nome da dupla.
   ```
    ├── entrega-projeto
    |  ├──github-search 
    |  ├──liana-alice // exemplo como deve ficar
   ```
